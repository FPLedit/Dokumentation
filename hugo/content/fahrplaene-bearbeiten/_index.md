...
{{< note title="Lineare Fahrpläne" >}}
Auf dieser Seite wird das Bearbeiten von Netzwerk-Fahrplänen beschrieben. Linearen Fahrplänen ist eine [eigene Seite](linear/) gewidmet. [Zur Unterscheidung der Typen](/einfuehrung/#netzwerk-oder-linearer-fahrplan).
{{< /note >}}
